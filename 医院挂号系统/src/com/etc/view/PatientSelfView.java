 ...
 * @author lenovo
 */
public class PatientSelfView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Object [][] patientArray = null;
        
     // 查询商品信息
        try {
        	List<Patient> goodses = PatientService.queryPatientByDoc(doctorName);
 		// 将 list 转为 二维数据
 		patientArray = ToolsUtil.loadGoodsArray(goodses);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientSelfView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientSelfView().setVisible(true);
            }
        });
    }
